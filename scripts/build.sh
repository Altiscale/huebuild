...
rpm -ivh ${RPM_DIR}/${ant_package} ${RPM_DIR}/asciidoc-8.4.5-4.1.el6.noarch.rpm ${RPM_DIR}/python-devel-2.6.6-51.el6.x86_64.rpm ${RPM_DIR}/python-simplejson-2.0.9-3.1.el6.x86_64.rpm --prefix ${INSTALL_DIR} --dbpath ${RPM_DB_DIR} --nodeps --quiet
