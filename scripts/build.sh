...
python-devel_link='ftp://rpmfind.net/linux/centos/6.5/os/x86_64/Packages/python-devel-2.6.6-51.el6.x86_64.rpm'
python-simplejson_link='ftp://rpmfind.net/linux/centos/6.5/os/x86_64/Packages/python-simplejson-2.0.9-3.1.el6.x86_64.rpm'
...
wget ${WGET_OPTS} ${python-devel_link} -O "${RPM_DIR}/python-devel-2.6.6-51.el6.x86_64.rpm"
wget ${WGET_OPTS} ${python-simplejson_link} -O "${RPM_DIR}/python-simplejson-2.0.9-3.1.el6.x86_64.rpm"
